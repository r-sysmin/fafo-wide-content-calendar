...
export function SocialAuthButtons({
  ...
  const handle = async (provider: SocialProvider) => {
    ...
    try {
      ...
      // Popup / web_message flow: the broker returned tokens and the session is
      // already set, but nothing navigates on its own. Hydrate the auth context
      // and move the user into the app — otherwise they sit on this page and it
      // looks like sign-in did nothing.

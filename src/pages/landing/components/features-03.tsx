  ...
  return (
    <section className="landing py-24">
      ...
      <div className="mx-auto mt-16 max-w-page px-6 sm:mt-20 md:mt-24 lg:px-8">
        <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-sm text-muted-foreground sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-8 lg:gap-y-16">
